...
exports.SaveThreadUseCase = void 0;
class SaveThreadUseCase {
    constructor(openaiService, chatThreadRepository) {
    ...
    execute(_a) {
        return __awaiter(this, arguments, void 0, function* ({ phone }) {
            ...
            const threadId = yield this.openaiService.createThread();
...
exports.SaveThreadUseCase = SaveThreadUseCase;
